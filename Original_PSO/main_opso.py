...
from Data_scripts.data_savegp import savexlsxgp
...
for i in range(len(seed)):
    ...
    c1, c2, c31, c41, length_scale, lam = 3.4302,	2.3488,	0.7546,	0,	1,	0.1
    ...
    ok = False
    e1, e2, e3, e4 = 'Pruebas/GP/Error' + str(seed[i]) + '.xlsx', 'Pruebas/GP/Sigma' + str(
        seed[i]) + '.xlsx', 'Pruebas/GP/Mu' + str(seed[i]) + '.xlsx', 'Pruebas/GP/Distance' + str(
        seed[i]) + '.xlsx'
    ...
    savexlsxgp(MSE_data, sigma_data, mu_data, distances, e1, e2, e3, e4)
