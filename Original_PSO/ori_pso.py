...
from Data_scripts.data_saveori import savexlsxori
...
for i in range(len(seed)):
    ...
    c1, c2, c31, c41, length_scale, lam = 3.4302,	2.3488,	0,	0,	1,	0.1
    ...
    ok = False
    w1, w2, w3, w4, w5 = 'Pruebas/Ori/Error'+str(seed[i])+'.xlsx', 'Pruebas/Ori/Sigma'+str(seed[i])+'.xlsx', 'Pruebas/Ori/Mu'+str(seed[i])+'.xlsx', 'Pruebas/Ori/Distance'+str(seed[i])+'.xlsx', 'Pruebas/Ori/Data'+str(seed[i])+'.xlsx'
    ...
    savexlsxori(MSE_data, sigma_data, mu_data, distances, w1, w2, w3, w4)
