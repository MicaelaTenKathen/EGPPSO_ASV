...
def model_psogp(c1, c2, c3, c4, leng_scale, lam):
    ...
    GEN, e1, e2, e3, e4 = 6000, 'Pruebas/Errorn50.xlsx', 'Pruebas/Sigman50.xlsx', 'Pruebas/Mun50.xlsx', 'Pruebas/Distancen50.xlsx'
    num = 3
    num_total = 10
    ...
    #while num < num_total:
    if num == 0:
        bench_function, X_test, grid, df_bounds, grid_or = bench_total(path[-1] + '/Data/shww.npy'.format(0), xs, ys, load_file=False,
                                                                       load_from_db=True)
    elif num == 1:
        ...
        bench_function, X_test, grid, df_bounds, grid_or = bench_total(path[-1] + '/Data/shww2.npy'.format(0), xs, ys, load_file=False,
                                                                       load_from_db=True)
    elif num == 3:
        ...
        bench_function, X_test, grid, df_bounds, grid_or = bench_total(path[-1] + '/Data/shww4.npy'.format(0), xs, ys, load_file=False,
                                                                       load_from_db=True)
    elif num == 5:
        ...
        bench_function, X_test, grid, df_bounds, grid_or = bench_total(path[-1] + '/Data/shww6.npy'.format(0), xs, ys, load_file=False,
                                                                       load_from_db=True)
    elif num == 7:
        ...
        bench_function, X_test, grid, df_bounds, grid_or = bench_total(path[-1] + '/Data/shww8.npy'.format(0), xs, ys, load_file=False,
                                                                       load_from_db=True)
    elif num == 9:
    ...
    seed = [20] #, 541, 65, 145, 541, 156, 158, 12, 3, 89] # 57, 123, 456, 789, 987, 654, 321, 147, 258, 369, 741, 852, 963, 159, 951, 753, 357, 756, 8462, 4875]
