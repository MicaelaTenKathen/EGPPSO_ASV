...
def part_fitness(g, GEN, xs, ys, part, s_ant, s_n, x_p, y_p, bench_function, y_data, n, n_plot, n_data, grid_min, X_test, creator, best,
    ...
    return x_p, y_p, y_data, x_bench, y_bench, part, best, n_plot, s_n
